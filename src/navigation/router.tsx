...
import { QuickPestoContentTypeList, UpdatePestoContentTypeCard } from "./pages/test.autoform"
...
export default function Layout(/*{ children }: { children: React.ReactNode }*/) {
    return (
        <>
            ...
            <Route path="/tests-autoform" component={QuickPestoContentTypeList} />
            <Route path="/tests-autoform-detail/:content_type_id_param?" component={UpdatePestoContentTypeCard} />
